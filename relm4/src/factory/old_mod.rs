...
pub trait FactoryPrototype<View: FactoryView<Self::Root>>: Component {
    type FactoryParam;
...
//     type Msg;
    ...
    fn init_params(param: Self::FactoryParam, returned_widget: &View::Root) -> Self::InitParams;
